...
<a
  href="/tag/{tag.id}"
  class="p-6 bg-primary-red text-primary-white text-center rounded-md shadow-sm hover:shadow-md flex flex-col items-center transition-transform transform transform-gpu {!pulsing ? "motion-safe:hover:scale-105" : "scale-95"}"
...
{/each}
 ({tag.ratingCount})</p>
{:else}
<p class="md:line-clamp-1 {pulsing ? "animate-pulse" : ""}">Unknown Rating</p>
{/if}
</a>
